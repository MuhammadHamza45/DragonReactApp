            ...
            {verified ? <Container>
                ...
                <Row>
                    ...
                    <Col lg={4} xl={4} md={12} sm={12}>
                        <PricingPlan planId='price_1MrHUCKiazAS3onP0ALyQJTf' detail={['All Free Features', '2 Profiles', 'Add your own subjects, 1 free/month and 1 earned every 5 hours played', 'Send 10 audio/images/month and we integrate in your DragonCamp app (Total for all profiles) *Earn 1 new item every hour played']} planFee={5.99} theme="green" id={Id}/>
                    </Col>
                    <Col lg={4} xl={4} md={12} sm={12}>
                        <PricingPlan planId='price_1MrHUuKiazAS3onPH6eobGGJ' detail={['All $5.99 Features', 'Send us 30 audio/images/month and we will integrate them in your DragonCamp App', '3 Profiles', 'Reports for correct/incorrect answers in trivia']} planFee={14.99} theme="purple" id={Id}/>
                    </Col>
                    <Col lg={4} xl={4} md={12} sm={12}>
                        <PricingPlan planId='price_1MrHVWKiazAS3onPr8QtTgZH' detail={['All $14.99 Features', '4 Profiles', 'Send us 60 total Audio/image items for us to integrate in your DragonCamp', 'Reports for all kids account activity, trivia and item interactions.']} planFee={29.99} theme="green" id={Id}/>
                    </Col>
                </Row>
